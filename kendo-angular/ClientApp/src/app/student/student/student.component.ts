...
export class StudentComponent implements OnInit, DoCheck {
  ...
  title: string = null;
  show: number = 0;
  @ViewChild(StudentGridComponent, { static: false }) child: StudentGridComponent;
  @ViewChild(StudentQueryComponent, { static: false }) querychild: StudentQueryComponent;
  @ViewChild(StudentEditComponent, { static: false }) editchild: StudentEditComponent;
